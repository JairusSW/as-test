...
var balanced = __nccwpck_require__(317);
...
const types_js_1 = __nccwpck_require__(397);
const glob_1 = __nccwpck_require__(807);
const chalk_1 = __nccwpck_require__(551);
const child_process_1 = __nccwpck_require__(81);
const util_js_1 = __nccwpck_require__(324);
function build(args) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = Object.assign(new types_js_1.Config(), JSON.parse((0, fs_1.readFileSync)("./as-test.config.json").toString()));
        ...
        const inputFiles = yield (0, glob_1.glob)(config.input);
        ...
        if (config.buildOptions.parallel) {
            ...
            console.log(chalk_1.default.dim("Compiled in " + (0, util_js_1.formatTime)(performance.now() - start)) + "\n");
        }
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Glob = void 0;
const minimatch_1 = __nccwpck_require__(340);
const node_url_1 = __nccwpck_require__(41);
const path_scurry_1 = __nccwpck_require__(742);
const pattern_js_1 = __nccwpck_require__(908);
const walker_js_1 = __nccwpck_require__(439);
...
const minimatch_1 = __nccwpck_require__(340);
const glob_js_1 = __nccwpck_require__(110);
const has_magic_js_1 = __nccwpck_require__(490);
var minimatch_2 = __nccwpck_require__(340);
Object.defineProperty(exports, "escape", ({ enumerable: true, get: function () { return minimatch_2.escape; } }));
Object.defineProperty(exports, "unescape", ({ enumerable: true, get: function () { return minimatch_2.unescape; } }));
var glob_js_2 = __nccwpck_require__(110);
Object.defineProperty(exports, "Glob", ({ enumerable: true, get: function () { return glob_js_2.Glob; } }));
var has_magic_js_2 = __nccwpck_require__(490);
Object.defineProperty(exports, "hasMagic", ({ enumerable: true, get: function () { return has_magic_js_2.hasMagic; } }));
var ignore_js_1 = __nccwpck_require__(572);
 ...
 * @module
 */
const minipass_1 = __nccwpck_require__(598);
const ignore_js_1 = __nccwpck_require__(572);
const processor_js_1 = __nccwpck_require__(816);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AST = void 0;
const brace_expressions_js_1 = __nccwpck_require__(463);
const unescape_js_1 = __nccwpck_require__(30);
const types = new Set(['!', '?', '+', '*', '@']);
...
const brace_expansion_1 = __importDefault(__nccwpck_require__(168));
const assert_valid_pattern_js_1 = __nccwpck_require__(833);
const ast_js_1 = __nccwpck_require__(779);
const escape_js_1 = __nccwpck_require__(692);
const unescape_js_1 = __nccwpck_require__(30);
...
exports.Minimatch = Minimatch;
/* c8 ignore start */
var ast_js_2 = __nccwpck_require__(779);
Object.defineProperty(exports, "AST", ({ enumerable: true, get: function () { return ast_js_2.AST; } }));
var escape_js_2 = __nccwpck_require__(692);
Object.defineProperty(exports, "escape", ({ enumerable: true, get: function () { return escape_js_2.escape; } }));
var unescape_js_2 = __nccwpck_require__(30);
...
const node_events_1 = __nccwpck_require__(254);
const node_stream_1 = __importDefault(__nccwpck_require__(492));
const node_string_decoder_1 = __nccwpck_require__(915);
/**
...
const lru_cache_1 = __nccwpck_require__(209);
const node_path_1 = __nccwpck_require__(411);
const node_url_1 = __nccwpck_require__(41);
const fs_1 = __nccwpck_require__(147);
const actualFS = __importStar(__nccwpck_require__(561));
...
const chalk_1 = __nccwpck_require__(551);
const build_js_1 = __nccwpck_require__(944);
const run_js_1 = __nccwpck_require__(543);
...
if (!args.length) {
    if (flags.includes("--version") || flags.includes("-v")) {
        ...
        console.log(chalk_1.default.bold.blueBright("as-test") + " is a testing framework for AssemblyScript. " + chalk_1.default.dim("(v" + version + ")") + "\n");
    ...
    if (command === "build") {
        (0, build_js_1.build)(args);
    }
    else if (command === "run") {
        (0, run_js_1.run)();
    }
    else if (command === "test") {
        (0, build_js_1.build)(args).then(() => {
            (0, run_js_1.run)();
        });
    }
}
