...
export type CoveragePointDescriptor = {
  file: string;
  line: number;
  column: number;
  type: string;
...
export function describeCoveragePoint(
  file: string,
  line: number,
  column: number,
  fallbackType: string,
...
export function readCoverageSourceLine(file: string, line: number): string {
...
export function resolveCoverageHighlightSpan(
  visible: string,
  focus: number,
): [number, number] {
