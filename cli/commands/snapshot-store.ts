...
// Snapshot persistence and on-disk format, extracted from run-core. Owns the
// SnapshotStore used during a run plus the .snap text / .snap.json parsers and
// key canonicalization. Only SnapshotStore (and its reply type) are public.
